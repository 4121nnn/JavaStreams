...
import { login, REST_API_BASE_URL } from '../../service/Service';
...
const Login = () => {
  ...
  const handleGithubLogin = async () => {
    window.location.href = REST_API_BASE_URL + '/oauth2/authorization/github';
  };
    ...
    <div className="h-screen flex flex-col items-center justify-center relative overflow-hidden">
      ...
      <div className='relative flex flex-col items-center justify-center max-w-5xl h-screen w-full'>
        ...
        <div className="relative flex flex-col gap-4 p-7 border border-neutral-500 rounded-xl z-10">
          <div>
            <p className='pl-1 mb-2 text-neutral-300'>Sign In <span></span></p>
          </div>
          <div>
          ...
          <div className='mt-3'>
            <span className='text-sm text-neutral-500 mr-2'>No account? </span><a href="/signup" className='text-neutral-300 text-sm hover:text-neutral-50'>Create One</a>
          </div>
        </div>
      </div>
    </div>
